              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="active tab-pane" id="profile">
                    <form class="form-horizontal" action="{{route('superadmin.profile.update')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal" action="{{route('superadmin.changepassword')}}" method="POST">
                        @csrf
                        @method('PUT')
                      <div class="form-group row">
